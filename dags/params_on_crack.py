...
@dag(
    ...
    params={
        ...
        # Note if you can add any HTML formatting to the description, you need to use the description_md
        # attribute.
        "most_loved_number": Param(
            42,
            type="integer",
            title="You favorite number",
            description_md="""Everybody should have a favorite number. Not only math teachers.
        ...
        "color_picker": Param(
            ...
            type="string",
            title="Pick a color",
            description_md="""This is a special HTML widget as custom implementation in the DAG code.
