...
from dags.nba_elt_pipeline_dag_qa import (
    jacobs_ecs_task,
    jacobs_dummy_task,
    JACOBS_DEFAULT_ARGS,
    create_dag,
...
class test_nba_elt_pipeline_dag:
    ...
    @patch("dags.nba_elt_pipeline_dag_qa.jacobs_ecs_task")
...
def test_nba_elt_pipeline_dag_qa_dag():
    ...
    assert test_dag.tasks[0].task_id == "jacobs_airflow_ecs_task_qa"
